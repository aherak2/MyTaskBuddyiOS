...
class _MyStepperState extends State<MyStepper> {
  ...
  void _handleSubmit() async {
    ...
    final selectedAvatarUrl = selectedAvatar;
    ...
    try {
      ...
      final results = await connection.query('INSERT INTO users (firstname, lastname, avatar,username,password) VALUES (@firstName, @lastName, @avatar,@username,@password) RETURNING id', substitutionValues: {
        'firstName': firstName,
        'lastName': lastName,
        'avatar': selectedAvatarUrl['url'],
        'username':user,
        'password':pass
      });
      if (results.isNotEmpty) {
        final userId = results[0][0];
...
class YellowPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    ovalPath.quadraticBezierTo(
        width*1.7, height*0.02 , width, height *0.5);
